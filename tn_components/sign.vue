<template>
	<view>
		<view class="wrapper">
			<view class="handBtn">
				<image @click="selectColorEvent('black','#1A1A1A')" :src="selectColor === 'black' ? 'https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/other/color_black_selected.png' : 'https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/other/color_black.png'"
				 :class="[selectColor === 'black' ? 'color_select' : '', 'black-select']"></image>
				<image @click="selectColorEvent('red','#ca262a')" :src="selectColor === 'red' ? 'https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/other/color_red_selected.png' : 'https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/other/color_red.png'"
