	...
	<view>
		...
		<view class="container">
			...
			<view class="requirement">
				...
				<view class="errorBox">
					<view class="item1">
						<image class="iconImg" src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/discern/ok.png" mode="widthFix"></image>
					</view>
					<view class="item2">
						<image class="iconImg" src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/discern/no.png" mode="widthFix"></image>
					</view>
					<view class="item3">
						<image class="iconImg" src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/discern/no.png" mode="widthFix"></image>
					</view>
...
<style lang="scss" scoped>
	...
	.uploadBox {
		...
		.uploadItem {
			...
			.imgEx1 {
				background: url('https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/discern/ex1.png');
				background-size: 82%;
			...
			.imgEx2 {
				background: url('https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/discern/ex2.png');
				background-size: 82%;
				background-repeat: no-repeat;
				background-position: center;
			}
	...
	.requirement {
		...
		.errorBox {
			...
			.item1 {
				background-image: url('https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/discern/yes.png');
				background-repeat: no-repeat;
				background-size: 100%;
				position: relative;
			}
			...
			.item2 {
				background-image: url('https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/discern/error1.png');
				background-repeat: no-repeat;
				background-size: 100%;
				position: relative;
			}
			...
			.item3 {
				background-image: url('https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/discern/error2.png');
				background-repeat: no-repeat;
				background-size: 100%;
				position: relative;
			}
			...
			.item4 {
				background-image: url('https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/discern/error3.png');
				background-repeat: no-repeat;
				background-size: 100%;
				position: relative;
			}
