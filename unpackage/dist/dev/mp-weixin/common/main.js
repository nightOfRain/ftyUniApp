...
/* 0 */
/*!*****************************************************!*\
  !*** /Users/wenjieliu/hbuilderSpaces/天源房易通/main.js ***!
  \*****************************************************/
...
var _utils = _interopRequireDefault(__webpack_require__(/*! ./utils */ 18));
...
var _uviewUi = _interopRequireDefault(__webpack_require__(/*! uview-ui */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}_vue.default.prototype.$store = _store.default;var cuCustom = function cuCustom() {__webpack_require__.e(/*! require.ensure | colorui/components/cu-custom */ "colorui/components/cu-custom").then((function () {return resolve(__webpack_require__(/*! ./colorui/components/cu-custom.vue */ 387));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('cu-custom', cuCustom);var TnCustom = function TnCustom() {__webpack_require__.e(/*! require.ensure | components/TnCustom/TnCustom */ "components/TnCustom/TnCustom").then((function () {return resolve(__webpack_require__(/*! ./components/TnCustom/TnCustom.vue */ 392));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('tn-custom', TnCustom);_vue.default.prototype.imgPath = "https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/"; // 引入:uView-UI
_vue.default.use(_uviewUi.default);
var baseUrl = 'https://www.wuhannantian.cn:8091/';
//const baseUrl = 'http://127.0.0.1:8899/'
_vue.default.config.productionTip = false;
_vue.default.prototype.updateWx = function () {

  var userInfo = uni.getStorageSync('userInfo');
  if (_utils.default.isEmpty(userInfo) || userInfo.loginStat) {
    console.log("==========没登录啊=============");
    return;
  }
  //同步微信数据
  ...
  _store.default.commit('userinfo/updateUserinfo', userInfo);
};
  ...
  uni.request({
    ...
    success: function success(res) {
      ...
      if (res.code == '200') {
        ...
        _store.default.commit('userinfo/updateLoginStat', false);
        //uni.$emit('update', {});
        uni.showModal({
          title: '交易失败：' + res.msg,
          success: function success(res) {
...
_vue.default.prototype.commRequestGet = function (trancode, data, succ) {
  var token = '';
  if (trancode != '/login') {
    token = uni.getStorageSync('accessToken');
  }

  var baseUrl = 'http://www.sjyjr.net/sjyjf/app/';
  console.log('baseURL:' + baseUrl + trancode + ' send:' + JSON.stringify(data));
  console.log('token:' + token);
  uni.showLoading({
    title: '加载中' });
...
_vue.default.prototype.commRequestPost = function (trancode, data, succ) {
  var token = '';
...
/* 5 */
/*!*****************************************************!*\
  !*** /Users/wenjieliu/hbuilderSpaces/天源房易通/App.vue ***!
  \*****************************************************/
/*! no static exports found */
...
/* 6 */
/*!******************************************************************************!*\
  !*** /Users/wenjieliu/hbuilderSpaces/天源房易通/App.vue?vue&type=script&lang=js& ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 7 */
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/wenjieliu/hbuilderSpaces/天源房易通/App.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
  ...
  onLaunch: function onLaunch() {
    uni.getSystemInfo({
      success: function success(e) {
        ...
        _index.default.commit('systeminfo/updateSystemInfo', e);
      } });
...
/* 15 */
/*!***************************************************************************************!*\
  !*** /Users/wenjieliu/hbuilderSpaces/天源房易通/App.vue?vue&type=style&index=0&lang=scss& ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 16 */
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/wenjieliu/hbuilderSpaces/天源房易通/App.vue?vue&type=style&index=0&lang=scss& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
