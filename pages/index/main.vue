<template>
	<view class="components-home">
		...
		<!-- <my-components @click.native="clickMyComponents" :title.sync="title" style="height:200px;background-color: #0081FF;"></my-components> -->
		<block v-for="(item,index) in tabbar" :key="index">
			...
			<view class='nav-list margin-top'>
				<navigator open-type="navigate" hover-class='none'  :class="'nav-li bg-index' + (index+1)"
				 v-for="(item1, index1) in item.children" :url="'../loan/loaninfo?type=' + item1.id" :key="item1.id">
					<view class="nav-title">{{item1.label}}</view>
					<view class="nav-name">最高可待15万</view>
				</navigator>
			</view>
		</block>
...
<script>
	import myComponents from '@/components/my-components.vue'
	export default {
