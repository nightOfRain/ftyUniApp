...
<!-- 弹窗确认 -->
		...
		<block>
			<view class='padding flex text-center text-grey bg-white shadow-warp-my'>
				<view class='flex flex-sub flex-direction solid-right'>
					<view class="text-xxl text-orange">9笔</view>
					<view class="margin-top-sm">
						<text class='cuIcon-hot'></text> 签单量</view>
				</view>
				<view class='flex flex-sub flex-direction solid-right'>
					<view class="text-xxl text-blue">86%</view>
					<view class="margin-top-sm">
						<text class='cuIcon-share'></text> 开单率</view>
				</view>
				<view class='flex flex-sub flex-direction'>
					<view class="text-xxl text-red">1428万</view>
					<view class="margin-top-sm">
						<text class='cuIcon-like'></text> 总额度</view>
				</view>
			</view>
			...
			<view class="cu-list menu card-menu margin-top-lg margin-bottom-lg shadow-shop bg-white text-black my-radius sm-border">
				<view class="cu-item ">
					<button class='content cu-btn' @click="goSalary">
						<image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/icon/jisuanqi.png" class='png' mode='aspectFit'></image>
						<text class='text-lg margin-sm'>业绩龙虎榜</text>
					</button>
					<view class="action">
						<view class="cu-tag round bg-orange light">签单率</view>
						<view class="cu-tag round bg-olive light">绩效</view>
						<view class="cu-tag round bg-blue light">单量</view>
					</view>
				</view>
				<view class="cu-item" @click="goAchievement">
					<button class='content cu-btn' open-type="contact">
						<image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/icon/diannao.png" class='png' mode='aspectFit'></image>
						<text class='text-lg margin-sm'>销售业绩</text>
					</button>
					<view class="action">
						<view class="cu-tag round bg-orange light">销售经理</view>
						<view class="cu-tag round bg-olive light">本月</view>
					</view>
				</view>
				<view class="cu-item" @click="goTeamSales">
					<button class='content cu-btn' open-type="contact">
						<image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/icon/diannao.png" class='png' mode='aspectFit'></image>
						<text class='text-lg margin-sm'>团队业绩</text>
					</button>
					<view class="action">
						<view class="cu-tag round bg-orange light">销售团队</view>
						<view class="cu-tag round bg-olive light">历史</view>
					</view>
				</view>
				<view class="cu-item" @click="goCustomerAnalysis">
					<button class='content cu-btn' open-type="contact">
						<image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/icon/diannao.png" class='png' mode='aspectFit'></image>
						<text class='text-lg margin-sm'>数据分析</text>
					</button>
					<view class="action">
						<view class="cu-tag round bg-orange light">同比</view>
						<view class="cu-tag round bg-olive light">环比</view>
					</view>
				</view>
				<view class="cu-item " @click="goCourse">
					<button class='content cu-btn'>
						<image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/icon/youjian.png" class='png' mode='aspectFit'></image>
						<text class='text-lg margin-sm'>业务培训</text>
					</button>
					<view class="action">
						<view class="cu-tag round bg-orange light">视频</view>
						<view class="cu-tag round bg-olive light">图片</view>
						<view class="cu-tag round bg-blue light">会议</view>
					</view>
				</view>
			</view>
			<!-- 门店用户 -->
			<view class="cu-list menu card-menu margin-top-lg margin-bottom-lg shadow-shop bg-white text-black my-radius sm-border">
				...
				<view class="cu-item ">
					<button class='content cu-btn' @click="goStore">
						<image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/icon/jisuanqi.png" class='png' mode='aspectFit'></image>
						<text class='text-lg margin-sm'>门店管理</text>
					</button>
					<view class="action">
						<view class="cu-tag round bg-orange light">人员</view>
						<view class="cu-tag round bg-olive light">地理位置</view>
					</view>
				</view>
				<view class="cu-item ">
					<button class='content cu-btn' @click="goQrcode">
						<image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/icon/jisuanqi.png" class='png' mode='aspectFit'></image>
						<text class='text-lg margin-sm'>推广码</text>
					</button>
					<view class="action">
						<view class="cu-tag round bg-orange light">海报</view>
						<view class="cu-tag round bg-olive light">二维码</view>
					</view>
				</view>
			</view>
			<!-- 外部用户 -->
			<view class="cu-list menu card-menu margin-top-lg margin-bottom-lg shadow-shop bg-white text-black my-radius sm-border">
				<view class="cu-item ">
					<button class='content cu-btn' open-type="contact">
						<image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/icon/diannao.png" class='png' mode='aspectFit'></image>
						<text class='text-lg margin-sm'>我的审贷</text>
					</button>
					<view class="action">
						<view class="cu-tag round bg-orange light">外部用户</view>
						<view class="cu-tag round bg-olive light">历史</view>
					</view>
				</view>
			</view>
			...
			<view class="cu-list menu card-menu margin-top-lg margin-bottom-sm shadow-shop bg-white text-black my-radius sm-border">
				<view class="cu-item" @tap="showModal" data-target="Modal">
					<view class='content'>
						<image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/icon/zhuti.png" class='png' mode='aspectFit'></image>
				...
				<view class="cu-item">
					<button class='content cu-btn' open-type="share">
						<image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/icon/lvhang.png" class='png' mode='aspectFit'></image>
						<text class='text-lg margin-sm'>分享小程序</text>
					</button>
				</view>
				
				<view class="cu-item" @click="callPhoneNumber" data-number="15071177366">
					<view class='content'>
						<image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/icon/dengta.png" class='png' mode='aspectFit'></image>
						<text class='text-lg margin-sm'>技术支持</text>
					</view>
					<view class="action">
						<view class="cu-tag round bg-blue light">150 711 77366</view>
					</view>
				</view>
				
				<view class="cu-item">
					<button class='content cu-btn' @click="goAboutMe">
						<image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/icon/xiaoxi.png" class='png' mode='aspectFit'></image>
		...
		<view class="padding flex flex-direction">
			<button class="cu-btn bg-grey lg" @click="openLogin">立即登录</button>
			<button class="cu-btn bg-red margin-tb-sm lg" @click="quitApp">退出账号</button>
			<button class="cu-btn bg-red margin-tb-sm lg" @click="wxPay()">测试支付</button>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			goAchievement(){
				uni.navigateTo({
					url: '/pages/me/achievement'
				})
			},
			// 团队业绩
			goTeamSales(){
				uni.navigateTo({
					url: '/pages/me/teamSales'
				})
			},
			// 数据分析
			goCustomerAnalysis(){
				uni.navigateTo({
					url: '/pages/me/customerAnalysis'
				})
			},
			// 课班信息
			goCourse() {
...
<style lang="scss" scoped>
	...
	.nav-li {
		...
		width: 45%;
		margin: 0 2.5% 40upx;
		background-image: url("https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/me/NyU04x.png");
		background-size: cover;
		background-position: center;
		position: relative;
		z-index: 1;
