...
<template>
  <view class="about">
	...
	<view class="titleZ text-center align-center">
		...
		<view class="contentZ">
			<text class="text-xl">项目作者:刘文杰，一名有多年经验的八零后移动前端程序员，坐标武汉，擅长各种平台APP、小程序开发</text>
		</view>
	</view>
	...
	<view class="titleZ text-center align-center margin-top-xl">
		...
		<view class="contentZ margin-top-lg">
			<text class="text-xl text-bold">「房易通」</text>
			<text class="text-xl">：一款综合平台小程序，为贷款客户提供便捷服务～</text>
		</view>
		<view class="contentZ" style="margin-top: 40rpx;">
			<text class="text-xl text-bold">「功能点」</text>
			<text class="text-xl">：客户可以通过小程序进行审贷、进度跟踪及行业资讯，小程序本身不涉及贷款相关功能。</text>
		</view>
	</view>
	
    <button class='' open-type="contact">
      <image src="https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/static/logo.png" class='share-img png round shadow-lg bg-white' mode='aspectFit'>
      </image>
    </button>
  </view>
</template>
