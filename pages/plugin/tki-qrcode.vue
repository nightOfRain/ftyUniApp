<template xlang="wxml" minapp="mpvue">
	<view>
		...
		<view class="padding flex flex-direction margin-top-xl" @click="_makeCode()">
...
export default {
	...
	props: {
		...
		icon: {
			type: String,
			default: 'https://7869-xiyuqing-20131015-1259653561.tcb.qcloud.la/icon/WechatIMG6665.png'
		},
		iconSize: {
			type: Number,
			default: 40
	...
	methods: {
		...
		_saveCode() {
			console.log("==========_saveCode:"+this.result);
			let that = this;
			if (this.result != "") {
